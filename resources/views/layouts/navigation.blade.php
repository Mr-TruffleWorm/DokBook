            ...
            <div class="flex">
                <div class="navigation">
                    ...
                    <button @click="open = !open" class="toggle-btn">
                        <span class="material-symbols-outlined" :class="{ 'rotate': open }">account_circle</span>
                    </button>
                    ...
                    <div x-show="open" 
                        ...
                        <a href="#" class="dropdown-item">My Appointments</a>
                        <a href="#" class="dropdown-item">Medical Records</a>
